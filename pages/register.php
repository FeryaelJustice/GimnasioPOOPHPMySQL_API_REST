...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["signup"])) {
        if ($_POST["password"] == $_POST["repeatpassword"]) {
            $usuari = new Usuari();
            if ($usuari->createUsuari($_POST["nom"], $_POST["llinatges"], $_POST["telefon"], $_POST["username"], $_POST["password"])->correctOperation) {
...
<div class="row">
    <div class="col-sm-4">
        ...
        <a href="/projects/tasku5dawes/index.php?page=login"><strong>Volver.</strong></a>
    </div>
</div>