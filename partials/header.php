...
<head>
    ...
    <title>Tasca DWES5 - Gimnàs amb mySQL</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="/projects/tasku5dawes/index.php?page=login"><strong>Gimnàs</strong></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link<?php echo ($page == "reservar" ? " active\" aria-current=\"page" : "") ?>" href="/projects/tasku5dawes/index.php?page=reservar">Reservar pista</a>
                    <a class="nav-link<?php echo ($page == "reserves" ? " active\" aria-current=\"page" : "") ?>" href="/projects/tasku5dawes/index.php?page=reserves">Veure reserves</a>
                    <?php
